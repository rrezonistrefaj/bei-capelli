...
import { WelcomeSectionData, WelcomeItem, StrapiRichTextBlocks } from "@/types/strapi"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-12 gap-x-12">
          {sortedItems.map((item: WelcomeItem, idx: number) => (
            ...
            >
              ...
              <RichText content={item.description as StrapiRichTextBlocks} className="text-xl font-light text-black" />
            </motion.div>
          ))}
        </div>
      </div>
